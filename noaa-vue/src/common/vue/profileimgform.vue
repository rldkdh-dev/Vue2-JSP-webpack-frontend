<template>
   <div class="upload_file_wrap" :id="pass.id">
        <div class="img_area img_upload box no-img" v-if="viewModel.uploadImageSrc.length == 0">
            <label :for="pass.id+'_img_upload_01'" class="btn btn-white">
                ...
                <svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-camera"></use></svg>프로필사진첨부(선택)
            </label>
            <ul>
