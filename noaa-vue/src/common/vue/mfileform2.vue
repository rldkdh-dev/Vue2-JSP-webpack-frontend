    ...
    <ul id="tbl_filelist" :id="pass.id">
        <li v-for="(item, i) in viewModel.filelist" :key="i" :id="pass.id+i">
            <div class="upload_file_wrap">
                ...
                <div class="icon_box">
                    <button class="btn btn-icon"><svg class="icon" @click="fnAddFile()"><use xlink:href="../../../img/symbol-defs.svg#icon-add-circle"></use></svg></button>
                    <button class="btn btn-icon"><svg class="icon" @click="fnDeleteFile(i)"><use xlink:href="../../../img/symbol-defs.svg#icon-circle-minus"></use></svg></button>
                </div>
                <div class="icon_box">
                    <button class="btn btn-icon"><svg class="icon" @click="fnMoveFile(i, -1)"><use xlink:href="../../../img/symbol-defs.svg#icon-arrow-up-circle"></use></svg></button>
                    <button class="btn btn-icon"><svg class="icon" @click="fnMoveFile(i, 1)"><use xlink:href="../../../img/symbol-defs.svg#icon-arrow-down-circle"></use></svg></button>
                </div>
            </div>
        </li>
    </ul>
