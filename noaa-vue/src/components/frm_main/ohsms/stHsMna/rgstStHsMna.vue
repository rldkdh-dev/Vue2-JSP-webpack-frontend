...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fnPdfView:function(path, fileNm){    
                this.bool = true;
                this.signPop = false;
                this.$refs.PDFviewer.fnSetContents(path, fileNm,'현장안전보건매뉴얼');                
            },
            ...
            callPushAlarm: function(user_id) {
                ...
                $.ajax({
                    ...
                    data:{
                        // 제목 및 내용
                        title : "안전보건 매뉴얼 현장소장 결재가 완료되었습니다.",
                        message : "PC에서 확인해주세요.",
                        user_id : user_id,
                        // 클릭 시 이동 화면주소
                        link : link
