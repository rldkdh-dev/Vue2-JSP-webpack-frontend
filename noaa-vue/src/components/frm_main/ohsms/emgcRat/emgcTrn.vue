...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fnPdfView:function(path, orgfileNm){    
                this.bool = true;
                this.signPop = false;
                this.$refs.PDFviewer.fnSetContents(path, orgfileNm,'비상훈련/교육');                
            },
            ...
            callPushAlarm: function(user_id) {
                ...
                $.ajax({
                    ...
                    data:{
                        // 제목 및 내용
                        title : "비상훈련/교육 현장소장 결재가 완료되었습니다.",
                        message : "PC에서 확인해주세요.",
                        user_id : user_id,
                        // 클릭 시 이동 화면주소
                        link : link
