    ...
    export default {
      ...
      methods: {
        ...
        fnUserdeptList:function(sn,search){
            ...
            Axios.post("/userdeptlist.do",{sn:sn,text:search,bplc_sn:vm.bplc_sn}).then(function(res){
