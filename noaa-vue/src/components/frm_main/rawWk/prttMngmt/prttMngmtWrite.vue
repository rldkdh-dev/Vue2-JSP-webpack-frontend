            ...
            <table class="table horizontal write">
                <tbody>
                    ...
                    <!-- <tr>
                        ...
                        <td><input type="text" id="prtc_eqpmnt_nm" v-model="viewModel.data.prtc_eqpmnt_nm"></td>
                    </tr> -->
                    <tr>
...
<script>
    ...
    mounted: function() {
		...
		vm.fnInit();
        if(vm.prtc_eqpmnt_sn != undefined && vm.prtc_eqpmnt_sn != null && vm.prtc_eqpmnt_sn != '') {
    ...
    methods: {
        fnInit: function() {
            ...
            let prtc_eqpmnt_sn = vm.$route.params.prtc_eqpmnt_sn;

                if(prtc_eqpmnt_sn != undefined){
                    vm.fnDetail(prtc_eqpmnt_sn);
                }
            ...
            fngetFileInfo:function(frm){
                ...
                let data = {
                    ...
                    dt:$('#dt').val(),
                    // prtc_eqpmnt_nm:vm.viewModel.data.prtc_eqpmnt_nm,
                    ...
                    prtc_eqpmnt_sn:vm.$route.params.prtc_eqpmnt_sn,
                ...
                frm.append("filePath", "prttMngmt");

                if(vm.prtc_eqpmnt_sn != undefined && vm.prtc_eqpmnt_sn != null && vm.prtc_eqpmnt_sn != ''){
                    if(confirm('수정하시겠습니까?')){
                        Axios.post("/updatePrttMngmt.do",frm).then(function(rs){
                            vm.isSaved = true;
                            vm.$router.push('/');
                            alert('수정되었습니다.');
                        })
                    ...
                    if(confirm('등록하시겠습니까?')){
                        if(vm.viewModel.data.bplc_sn == '' || vm.viewModel.data.bplc_sn == null){
                            ...
                            Axios.post("/insertPrttMngmt.do",frm).then(function(rs){
                                vm.isSaved = true;
                                vm.$router.push('/');
                                alert('등록되었습니다.');
                            })
