				...
				<div class="contents popup_contents">
					<div>
						<div style="padding-bottom:5px">
							<label>승인 : </label>
							<input type="radio" id="rvwY" v-model="viewModel.data.rvw_opnn_reg_yn" value="Y"><label for="rvwY" style="padding-left:5px">완료</label>
							<input type="radio" id="rvwN" v-model="viewModel.data.rvw_opnn_reg_yn" value="N"><label for="rvwN" style="padding-left:5px">보류</label>
						</div>
						<div style="padding-bottom:5px">
							<label for="">사유</label>
							<textarea v-model="viewModel.data.rvw_opnn_reg_rs">{{ viewModel.data.rvw_opnn_reg_rs }}</textarea>
						</div>
						<aprvFileform @filelist="fnFilelist"  @fileDelete="fnFileDelete" :pass="{id:'rvw'}" :ref="'files'"></aprvFileform>
					</div>
					<div class="btn-group">
	...
	methods: {
		...
		fngetFileInfo:function(frm){
			...
			let send = {
				...
				file_se: '10',
				rvw_opnn_reg_yn: vm.viewModel.data.rvw_opnn_reg_yn,
				rvw_opnn_reg_rs: vm.viewModel.data.rvw_opnn_reg_rs,
