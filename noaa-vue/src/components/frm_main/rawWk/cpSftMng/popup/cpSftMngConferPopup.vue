		...
		<div class="popup modal">
			<div class="popup_panel">
				...
				<div class="contents popup_contents">
					<div>
						<conferFileform @filelist="fnFilelist"  @fileDelete="fnFileDelete" :pass="{id:'cf'}" :ref="'files'"></conferFileform>
					</div>
					<div class="btn-group">
...
import conferFileform from "../../../../../common/vue/fileform2";
import fileViewPopup from '../../../../../common/vue/fileViewPopupCp.vue';

export default {
	components: {
		'conferFileform' : conferFileform,
