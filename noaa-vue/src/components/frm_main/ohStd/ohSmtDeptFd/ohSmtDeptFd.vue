<template>
    <div>
        <div>
            ...
            <div class="table_top">
                <h4>
                    <span @click="fnTitleClick(0)" class="btn-link">스마트사업부 업무폴더</span><span v-for="(item, idx) in titleList">> <span @click="fnTitleClick(item)" :class="'btn-link'" >{{ item.folder_nm }}</span></span>
                </h4>
            </div>
            <table class="table">
                <caption>스마트사업부 공유폴더 목록</caption>
                <thead>
                    <tr>
