<template>
    <div>
        <div>
            ...
            <div class="table_top">
                <h4>
                    <span @click="fnTitleClick(0)" class="btn-link">인프라사업부 업무폴더</span><span v-for="(item, idx) in titleList">> <span @click="fnTitleClick(item)" :class="'btn-link'" >{{ item.folder_nm }}</span></span>
                </h4>
            </div>
            <table class="table">
                <caption>인프라사업부 업무폴더 목록</caption>
                <thead>
                    <tr>
            ...
            <div class="table_footer btn-right">
                ...
                <div class="btn-group"> 
                    ...
                    <button class="btn btn-purple" @click="fnFolderAdd();" v-if="viewModel.userInfo.bplc_yn == 'N'"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-folder-filled"></use></svg>폴더등록</button>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            fnInit: function(){
                ...
                vm.dept_sn = vm.viewModel.userInfo.dept_sn == 0 ? '' : vm.viewModel.userInfo.dept_sn;
