<template>
    <div>
        <div>
            <div class="table_top">
                <h4>
                    <span @click="fnTitleClick(0)" class="btn-link">안전보건팀 업무 폴더</span><span v-for="(item, idx) in titleList">> <span @click="fnTitleClick(item)" :class="'btn-link'" >{{ item.folder_nm }}</span></span>
                </h4>
            </div>
            <table class="table">
