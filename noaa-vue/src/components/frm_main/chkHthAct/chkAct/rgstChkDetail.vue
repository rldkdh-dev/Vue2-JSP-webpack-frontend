    ...
    <div>
        <div class="contents write">
            <div class="btn-group btn-right">
                ...
                <button class="btn btn-purple btn-print" @click="fnPrint();"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-print"></use></svg>인쇄</button> -->
                <button :class="'btn btn-purple'" @click="fnViewPopup(viewModel.data.chck_act_sn);"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-manage-search"></use></svg>미리보기</button>
            </div>
            <div>
                <table class="table horizontal write" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{viewModel.data.chck_mttr}}</td>
                        </tr>
            ...
            <rgstChkSubDetail ref="sub" :pass="{mode: 'view', gbn:'chk'}" v-else></rgstChkSubDetail>
            <!-- <rgstChkMttrDetail ref="mttr" @mttrList="fnMttrList" :pass="{mode:'view'}" v-if="mttrForm==true"></rgstChkMttrDetail> -->
...
<script>
    ...
    export default {
        ...
        components: {
            // 'rgstChkMttrDetail' : rgstChkMttrDetail,
