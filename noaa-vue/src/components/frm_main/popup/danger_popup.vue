<template>
	<modal :pass="{widthObject: 450, popupTitle:'위험성평가 척도 선택'}">
...
export default {
	...
	mounted: function () {
		console.log('danger-popup')
	},
	methods: {
		fnInit: function(param) {
		...
		fnClick: function(freq, itns, result) {
			...
			if(vm.after == ''){
				...
				this.$parent.freq2 = freq;
				this.$parent.itns2 = itns;
				this.$parent.result2 = result;
				this.$parent.isPop = false;
