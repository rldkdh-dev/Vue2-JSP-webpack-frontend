        ...
        <template v-for="(item, idx) in viewModel.selCfnlList" >
                <li>
                    <button class="title">
                        ...
                        <!-- <input type="text" :class="'ml5 w200'" v-else v-model="item.spcmDetail.cfnl_nm"/> -->
    ...
    export default {
        ...
        methods: {
            ...
            fnItemSort: function(idx){
                ...
                // vm.viewModel.selCfnlList[idx].delcfnlList[i].job_process_sn.sort(function (a, b) {
                //     return a - b;
                // });
            ...
            fnItemDel:function(idx){
                ...
                for(let i = delList.length-1; i>=0; i--){
                    console.log("delList[i] " + delList[i]);
