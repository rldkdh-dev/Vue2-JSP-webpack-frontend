				...
				<div>
					<div class="table_top">
						...
						<div class="table_service">
							<router-link to="/write" class="btn btn-darkblue">신규등록</router-link>
						</div>
					</div>
			...
			setGrid: function () {
				...
				$("#couponManageList").jqGrid({
					...
					onSelectRow: function (id) {
						...
						vm.$router.push({path: '/detail', name:'managedetail', query : {key : rowData.SEQ_CP_NUM}});
					}
				})
