...
export default {
    ...
    methods: {
        fnList: function () {
            ...
            Axios.post("/getCouponList.do", senddata).then (function (rs) {
        ...
        setGrid: function () {
            ...
            let colMod = [
                ...
                {name: 'DT_COUPON_ST', index: 'DT_COUPON_ST'},
                {name: 'NM_CP', index: 'NM_CP'},
                {name: 'NM_CP_DVSN', index: 'NM_CP_DVSN'},
                {name: 'NM_WAY', index: 'NM_WAY'},
                {name: 'NM_CP_STATUS', index: 'NM_CP_STATUS'},
                {name: 'NM_REG_USER', index: 'NM_REG_USER'},
            ...
            $("#couponList").jqGrid({
                ...
                colNames : ['번호', '발행처', '쿠폰명','쿠폰종류','발행방법','상태','등록자','등록일자'],
                colModel : colMod,
                ...
                onSelectRow: function (id) {
                    ...
                    vm.$router.push({path: '/detail', name:'coupondetail', query : {key : rowData.SEQ_CP_NUM}});
