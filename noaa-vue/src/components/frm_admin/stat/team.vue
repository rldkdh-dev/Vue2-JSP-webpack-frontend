        ...
        <div class="box">
            ...
            <div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(item, i) in viewModel.list.filter(data => data.TEAMNAME !== '합계')" :key="i">
                            <td>{{ item.TEAMNAME }}</td>
                            <td>{{ item.GAME_CNT }}</td>
                    ...
                    <tfoot>
                        <tr v-for="(item, i) in viewModel.list.filter(data => data.TEAMNAME === '합계')" :key="'tfoot-' + i">
                            <td>{{ item.TEAMNAME }}</td>
                            <td>{{ item.GAME_CNT }}</td>
                            <td>{{ item.TICKET_CNT_Y }}</td>
                            <td>{{ item.AMT_PAYMENT_Y }}</td>
...
export default {
    ...
    methods: {
        fnList: function () {
            ...
            Axios.post("/getTeamList.do", send).then (function (rs) {
        ...
        fnExcelDownload: function () {
                ...
                Axios.post("/getTeamList.do", send)
