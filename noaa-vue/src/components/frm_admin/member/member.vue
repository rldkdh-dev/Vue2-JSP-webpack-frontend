...
<div>
    <div class="contents">
        <div class="box">
            <h3>기본검색
                <span class="btn-group btn-right">
                    <a href="" class="btn btn-blue">검색</a>
                </span>
            </h3>
            <!-- 검색영역 (한줄에 검색조건 최대 5개) -->
            <div class="search_container">
                <div>
                    <label for="">아이디<input type="text" title="" placeholder="입력해주세요"></label>
                    <label for="">이름<input type="text" title="" placeholder="입력해주세요"></label>
                    <label for="">
                        회원구분
                        <select title="">
                            <option>전체</option>
                            <option>일반</option>
                            <option>블루</option>
                            <option>블루패밀리 개인</option>
                            <option>블루패밀리 기업</option>
                            <option>어린이</option>
                        </select>
                    </label>
                    <label for="">
                        ...
                        <div class="datepicker_box">
                            <input type="text" class="datepicker" title="멤버십기간" placeholder="날짜 선택" readonly>
                        </div>
                        <span>~</span>
                        <div class="datepicker_box">
                            <input type="text" class="datepicker" title="멤버십기간" placeholder="날짜 선택" readonly>
                    ...
                    <label for="">어린이 가입코드<input type="text" title="" placeholder="입력해주세요"></label>
                </div>
                <div>
                    <label for="">멤버십번호<input type="text" title="" placeholder="입력해주세요"></label>
                    <label for="">
                        전화번호
                    ...
                    <label for="">시즌권(풀, 주말) 가입코드<input type="text" title="" placeholder="입력해주세요"></label>
                </div>
            </div>
        </div>
        <div class="box">
            <div>
                <div class="table_top">
                    ...
                    <div class="table_service">
                        ...
                        <button class="btn btn-green"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-excel"></use></svg>Excel 업로드</button>
                        <button class="btn btn-darkblue"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-person-add"></use></svg>블루패밀리 개인회원등록</button>
                        <button class="btn btn-darkblue"><svg class="icon"><use xlink:href="../../img/symbol-defs.svg#icon-person-add"></use></svg>블루패밀리 기업회원등록</button>
                    </div>
                </div>
                <table class="table">
