...
export default {
    ...
    mounted: function () {
        ...
        // Code 조회
        let data = {
            code_category_id : 'CD_GRADE',
        }
        Axios.post("/usingCodeList.do", data)
        .then (function (rs) {
            vm.viewModel.codeList = rs.data.codeList;

            vm.viewModel.colNames = ['산정기준년월', '등급구분', '등급구분코드'];

            rs.data.codeList.forEach(element => {
    ...
    methods: {
        fnList: function () {
            ...
            if (vm.viewModel.serachList.ym_calcu_basic != null && vm.viewModel.serachList.ym_calcu_basic != undefined && vm.viewModel.serachList.ym_calcu_basic != '') {
                data.ym_calcu_basic = vm.viewModel.serachList.ym_calcu_basic;
            }
        ...
        setGrid: function () {
            ...
            $("#gradeList").jqGrid({
                ...
                onSelectRow: function (id) {
                    ...
                    //eventBus.$emit('onDetail', firstData);
                    vm.$router.push({name: 'gradedetail', params : {ym_calcu_basic : firstData}});
                    //this.$router.push({name: 'gradedetail', params : {ym_calcu_basic : firstData}});
                }
                // onCellSelect : function (rowid, iCol, cellcontent, e) {
                //     console.log("CLICK ID:", rowid);
                //     console.log(iCol);
